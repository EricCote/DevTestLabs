...
$WebSourceEnt = "https://aka.ms/vs/16/release/vs_Enterprise.exe";
$WebSourcePro = "https://aka.ms/vs/16/release/vs_Professional.exe";
$WebSourceCom = "https://aka.ms/vs/16/release/vs_Community.exe";
...
$channel="VisualStudio.16.Release"
$workloads=@()

if ($Preview)
{
   $websource = $Websource.Replace("release","pre")
   $channel="VisualStudio.16.Preview"
}
...
{
    Write-Error "Failed to download vs2019 installer";
}
...
{
    Write-Error 'Failed to install VS2019';
}
