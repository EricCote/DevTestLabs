...
New-RsFolder  -Path / -Name Test1 -Verbose
Write-RsFolderContent -Path "C:\Users\afi\Downloads\PaginatedReportSamples" `
                      -Destination /Test1 -Verbose

$rsconfig = Get-RsDeploymentConfig -RsProjectFile 'C:\Users\afi\source\repos\AdventureWorks\AdventureWorks\AdventureWorks.rptproj' `
                  -ConfigurationToUse Release | Add-Member –PassThru –MemberType NoteProperty –Name ReportPortal –Value 'http://localhost/reports/'
